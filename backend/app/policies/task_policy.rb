...
# "registrar avanço / atribuir / reordenar" (record_progress). owner-only-card-delete:
# EXCLUIR a tarefa é owner-only (`destroy_commissioning`); criar/editar/atribuir
# seguem em owner+edit.
